...
// The CLI column of the "Basic usage" table. Asciidoctor's `asciidoctor
// document.adoc` command reads an AsciiDoc file and writes the rendered output;
// this crate's closest available counterpart is `adoc document.adoc`, which
// this test drives.
#[test]
fn basic_usage_via_adoc() {
    verifies!(
        r#"
a|
