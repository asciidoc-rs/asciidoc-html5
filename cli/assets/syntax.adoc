...
TIP: Convert this document using the `adoc` command to see the output produced from it.
...
Refer to a document attribute by enclosing its name in curly braces, like {url-docs}.
