...
* [**breaking**] Land the released inline-ast asciidoc-parser (0.31.0) ([#326](https://github.com/asciidoc-rs/asciidoc-html5/pull/326))

### Fixed

* Neutralize the clock in the stdin-routing comparison ([#328](https://github.com/asciidoc-rs/asciidoc-html5/pull/328))

## [0.1.8](https://github.com/asciidoc-rs/asciidoc-html5/compare/asciidoc-html5-v0.1.7...asciidoc-html5-v0.1.8)
_25 August 2026_

### Documented

* Revise usage of em and en dashes ([#323](https://github.com/asciidoc-rs/asciidoc-html5/pull/323))

### Updated dependencies

* *(deps)* Bump asciidoc-parser from 0.29.19 to 0.30.0 ([#324](https://github.com/asciidoc-rs/asciidoc-html5/pull/324))
...
* *(html5)* Escape the quote character in document-attribute-driven head values ([#321](https://github.com/asciidoc-rs/asciidoc-html5/pull/321))
* Resolve nested includes relative to their own containing file ([#320](https://github.com/asciidoc-rs/asciidoc-html5/pull/320))
...
* *(html5)* Port document_test.rb to SDD coverage ([#307](https://github.com/asciidoc-rs/asciidoc-html5/pull/307))
