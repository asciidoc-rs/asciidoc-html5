...
track_file!("docs/modules/ROOT/pages/api.adoc");
...
xref:convert-your-first-file.adoc[`adoc` CLI] will suit your needs. The API is for
...
* xref:convert-your-first-file.adoc[Convert your first file with the CLI]
* xref:index.adoc[Introduction and API examples]
"#
);
