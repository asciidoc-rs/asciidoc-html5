//! Coverage of the AsciiDoc language description's *Introduction* page.
//!
//! The page is a prose overview: what AsciiDoc is, why its syntax reads the way
//! it does, the range of output formats a processor can produce, and the status
//! of the documentation as the initial contribution to the Eclipse AsciiDoc
//! Language project. None of it states a rendering rule this crate can verify,
...
// The entire page is descriptive: it introduces AsciiDoc the language and the
// stewardship of its documentation, without specifying any behavior the
// renderer produces.
non_normative!(
    r#"
