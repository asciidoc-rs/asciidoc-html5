//! Coverage of the AsciiDoc language description's *Glossary of Terms* page.
//!
//! The page is a description list of AsciiDoc terminology, prefaced by a
//! "work in progress" caution. Every entry is a definition of a term, not a
//! rule for the renderer to verify — the page teaches vocabulary, not rendering
//! behavior — so the whole page is tracked as non-normative. (This crate does
//! render description lists and admonitions; that behavior is exercised on the
//! pages that document those constructs, not here.)

use crate::tests::sdd::*;

track_file!("ref/asciidoc-lang/docs/modules/ROOT/pages/glossary.adoc");

// A running glossary: each line defines a term of art in the AsciiDoc language.
// There is nothing here for a test to drive against the renderer.
non_normative!(
    r#"
= Glossary of Terms
