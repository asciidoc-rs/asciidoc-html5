//! Coverage of the AsciiDoc language description's *Section Attributes and
//! Styles Reference* page.
//!
//! This page is a cross-reference summary: two `[%autowidth]` tables cataloging
//! the section attributes and section styles, where every cell is an xref to
//! the dedicated page that documents (and, where applicable, verifies) that
//! feature. It introduces no new rendering rule of its own, so the entire page
//! is tracked non-normative here; the individual features are covered on their
//! own pages.
...
// The whole page is a catalog of section attributes and styles linking out to
// their dedicated pages; it states no rendering rule to verify here.
non_normative!(
    r#"
