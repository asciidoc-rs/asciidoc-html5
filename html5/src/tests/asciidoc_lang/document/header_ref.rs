//! Coverage of the AsciiDoc language description's *Document Header
//! Reference* page.
//!
//! This page is a reference table of the document-header attributes — their
//! value sources, the converters that honor them, and notes — followed by a
//! commented-out legacy table. It states no rendering behavior of its own (the
//! individual attributes are exercised on their dedicated pages), so the entire
...
// The reference table and the commented-out legacy table. Purely descriptive;
// each attribute's behavior is verified on its own page.
non_normative!(
    r#"
