//! Coverage of the AsciiDoc language description's *Document Attributes* page.
//!
//! This page introduces the concept of document attributes and the terminology
//! used to describe them (built-in vs. user-defined, setting, unsetting,
//! referencing). It is entirely conceptual — it contains no convertible example
//! with a rendered result — so the whole page is tracked as non-normative here.
//! The concrete behaviors it describes are verified on the dedicated pages
//! (see [`super::attribute_entries`], [`super::unset_attributes`],
//! [`super::reference_attributes`], and [`super::boolean_attributes`]).
