...
"#
    ...
    // `icons: font` selects a Font Awesome glyph (`<i class="fa fa-<name>">`)
    // for the icon macro.
...
"#
    ...
    // Each built-in admonition, in font mode, renders `<i class="fa
    // icon-<name>" title="<Label>">` — the CSS class the stylesheet maps to
    // a glyph.
