//! Coverage of Asciidoctor's *CodeRay* page.
//!
...
// CodeRay is a build-time (server-side) syntax highlighter. Supporting it —
// installing/invoking the coderay gem and emitting its `<span>` token markup —
// is a non-goal for this crate's 1.0, so none of this page's claims are
// verifiable here. The entire page is reproduced for coverage as non-normative.
non_normative!(
    r#"
= CodeRay
