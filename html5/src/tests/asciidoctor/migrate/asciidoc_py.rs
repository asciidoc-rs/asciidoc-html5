// The Asciidoctor "Migrate from AsciiDoc.py" page guides authors switching from
// the legacy Python AsciiDoc.py processor to Asciidoctor: it catalogs updated
// and deprecated syntax, compatibility mode, extension and configuration
// differences, and Ruby-processor workflows (doctest, text extraction, help
// topics). It is authoring- and processor-migration guidance rather than a
// specification of how this HTML5 renderer must render, so the whole page is
// tracked as non-normative. See `sdd/README.md`.

use crate::tests::sdd::*;

track_file!("ref/asciidoctor/docs/modules/migrate/pages/asciidoc-py.adoc");
