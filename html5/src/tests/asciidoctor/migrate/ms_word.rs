// The Asciidoctor "Migrate from MS Word to Asciidoctor" page surveys tools and
// strategies for turning MS Word documents into AsciiDoc — Pandoc, the Google
// Docs AsciiDoc Processor add-on, and a plain-text fallback — with detailed
// clean-up recipes. It documents external conversion workflows and authoring
// advice, stating no rule for this HTML5 renderer to satisfy, so the whole page
// is tracked as non-normative. See `sdd/README.md`.

use crate::tests::sdd::*;

track_file!("ref/asciidoctor/docs/modules/migrate/pages/ms-word.adoc");
