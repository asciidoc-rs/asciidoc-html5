// The Asciidoctor "Migrate from DocBook XML to Asciidoctor" page describes
// going the opposite direction from Asciidoctor's DocBook output: converting
// legacy DocBook XML (including doxygen's DocBook output) into AsciiDoc with
// the third-party DocBookRx tool. It documents an external conversion workflow
// — no rule for this HTML5 renderer to satisfy — so the whole page is tracked
// as non-normative. See `sdd/README.md`.

use crate::tests::sdd::*;

track_file!("ref/asciidoctor/docs/modules/migrate/pages/docbook-xml.adoc");
