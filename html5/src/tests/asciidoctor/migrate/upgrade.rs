// The Asciidoctor "Upgrade from Asciidoctor 1.5.x to 2.0" page helps authors
// move between Asciidoctor releases: it tabulates syntax, attributes, and API
// calls that were updated or deprecated across the major version bump. It is
// version-migration guidance for the Ruby processor and states no rule for this
// HTML5 renderer to satisfy, so the whole page is tracked as non-normative. See
// `sdd/README.md`.

use crate::tests::sdd::*;

track_file!("ref/asciidoctor/docs/modules/migrate/pages/upgrade.adoc");
