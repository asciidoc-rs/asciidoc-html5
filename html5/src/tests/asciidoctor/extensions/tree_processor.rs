// Asciidoctor's "Tree Processor Extension" page. It documents the
// TreeProcessor extension point, which runs against the parsed Document tree.
//
...
track_file!("ref/asciidoctor/docs/modules/extensions/pages/tree-processor.adoc");
