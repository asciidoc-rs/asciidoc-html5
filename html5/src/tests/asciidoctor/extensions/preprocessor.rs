// Asciidoctor's "Preprocessor Extension" page. It documents the Preprocessor
// extension point, which rewrites the raw source lines before parsing.
//
...
track_file!("ref/asciidoctor/docs/modules/extensions/pages/preprocessor.adoc");
