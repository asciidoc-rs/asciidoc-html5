// Asciidoctor's "Inline Macro Processor Extension Example" page. It walks
// through an InlineMacroProcessor that handles a custom inline macro.
//
...
track_file!("ref/asciidoctor/docs/modules/extensions/pages/inline-macro-processor.adoc");
