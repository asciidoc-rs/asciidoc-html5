// Asciidoctor's "Log from an Extension" page. It describes how an extension
// uses Asciidoctor's Ruby logger to report problems as log messages at a
// chosen severity.
//
...
track_file!("ref/asciidoctor/docs/modules/extensions/pages/logging.adoc");
