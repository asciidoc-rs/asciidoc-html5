// Asciidoctor's "Register Extensions" page. It shows the Ruby DSL and API
// calls for registering extensions with the Asciidoctor processor, per
// document or globally.
//
...
track_file!("ref/asciidoctor/docs/modules/extensions/pages/register.adoc");
