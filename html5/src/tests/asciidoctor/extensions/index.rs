// Asciidoctor's "Extensions" overview page. It introduces the Asciidoctor
// extension API and enumerates the available extension points (preprocessor,
// tree processor, postprocessor, and so on).
//
...
track_file!("ref/asciidoctor/docs/modules/extensions/pages/index.adoc");
