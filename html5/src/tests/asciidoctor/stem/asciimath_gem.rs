//! Coverage of Asciidoctor's *AsciiMath Gem* page.
//!
//! The AsciiMath Ruby gem translates AsciiMath expressions to MathML for the
//! *DocBook* backend/toolchain — a backend this crate does not target. None of
//! the page's claims are verifiable here, so the whole page is tracked as
//! non-normative.

use crate::tests::sdd::*;

track_file!("ref/asciidoctor/docs/modules/stem/pages/asciimath-gem.adoc");

// The AsciiMath gem exists to translate AsciiMath to MathML for the DocBook
// converter/toolchain, a backend this crate does not target. None of this
// page's claims are verifiable here, so the entire page is reproduced for
