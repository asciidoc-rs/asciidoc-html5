// The Asciidoctor "What's New" page is a chronological changelog of the
// 2.0.x release line: what changed in each patch release, written as
// descriptive prose. It states no rule for the renderer to satisfy, so the
// whole page is tracked as non-normative. See `sdd/README.md`.

use crate::tests::sdd::*;

track_file!("ref/asciidoctor/docs/modules/ROOT/pages/whats-new.adoc");
