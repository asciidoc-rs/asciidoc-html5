...
"#
    ...
    // Running Asciidoctor without parameters converts a file, which is
    // standalone output; render standalone here to match that default.
    let html = convert_with("= Hello\n\nWorld.", &Options::new().standalone(true));
