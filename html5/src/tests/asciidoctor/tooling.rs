// The Asciidoctor "AsciiDoc Tooling" page surveys the ecosystem of ways to
// author and preview AsciiDoc: hosted git repositories (GitHub, GitLab,
// Codeberg), web browser add-ons, and a catalog of IDEs and text editors
// (AsciiDocFX, Atom, Brackets, Eclipse, IntelliJ IDEA, SciTE, Visual Studio
// Code). None of these describe a rule this HTML5 renderer must satisfy — the
// page names no converter behavior, output format, or API — so the whole page
// is tracked as non-normative. See `sdd/README.md`.

use crate::tests::sdd::*;

track_file!("ref/asciidoctor/docs/modules/tooling/pages/index.adoc");
